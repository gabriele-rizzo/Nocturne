...
Non controlla di sua iniziativa finché non glielo permetti. Dopo che l'hai usata per un po', Nocturne fa la domanda una volta, e se dici di no non insiste. **Informazioni…** nel menu, oppure ⌘A, apre una finestra dove puoi cambiare idea, controllare subito, o lasciare che gli aggiornamenti si installino senza chiedere.
