...
It won't check on its own until you say it can. Once you've been using it for a little while, Nocturne asks the question once, and takes no for an answer. **Settings…** in the menu, or ⌘S, opens a window where you can check right now, change your mind about the automatic checks, or let updates install without being asked first.
